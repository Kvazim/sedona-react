                ...
                <nav className="main-nav">
                  ...
                  <ul className="disordered nav-user">
                    <li className="nav-user-item">
                      <a className="nav-user-link search-link" href="#">
                  ...
                  <path
                    ...
                    <li className="nav-user-item">
                      <a className="nav-user-link icon" href="#">
                      ...
                      <div className="popup">
                        <div className="popup-content">
                          <div className="popup-wrapper">
                            ...
                            <ul className="disordered popup-list">
                              <li className="popup-item">
                                <a className="card-favorites" href="#">
                          ...
                          <a className="btn all-favorits" href="#">Все избранные</a>
                        </div>
                      </div>
                    </li>
                    <li className="nav-user-item">
                      <a className="nav-user-link btn" href="#">Хочу сюда!</a>
                    </li>
                  </ul>
                </nav>
          </header>
